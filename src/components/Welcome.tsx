      ...
      <div ref={ref} className="container-max relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`reveal reveal-delay-2 ${isVisible ? 'is-visible' : ''}`}>
            <p className="eyebrow mb-5">About Emmanuel Gospel Ministries</p>
            <h2 className="text-section font-serif font-bold text-charcoal-900 text-balance">
              A Christ-Centred Ministry With a Heart for the Nations
            </h2>
            <div className="mt-6 space-y-4 text-base md:text-lg text-charcoal-600 leading-relaxed">
              <p>
                Emmanuel Gospel Ministries is a Christian ministry based in Hyderabad, Telangana,
                India, with a heart to proclaim Jesus Christ and serve people through Gospel
                ministry, prayer, evangelism, discipleship, revival meetings and missions.
              </p>
              <p>
                The ministry seeks to create opportunities for people to hear the Gospel, encounter
                God through prayer and worship, grow in biblical understanding and become faithful
                followers of Jesus Christ.
              </p>
            </div>

            {/* Our Heart */}
            <div className="mt-6 p-6 rounded-xl bg-brand-50 border-l-4 border-brand-700">
              ...
              <p className="text-base text-charcoal-700 leading-relaxed">
                We believe that the Gospel of Jesus Christ is the good news that every person needs
                to hear. Our desire is to take this message to cities, villages, communities and
                nations and to serve wherever God opens a door.
              </p>
            </div>
            ...
            <div className="mt-8 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-charcoal-500 mt-1 leading-relaxed">
                  Serves in Gospel ministry with a passion for proclaiming Jesus Christ, praying for
                  people, encouraging believers and reaching communities with the message of the Gospel.
                </p>
                <div className="mt-3 flex items-start gap-2">
                  <Quote className="h-4 w-4 text-gold-500 mt-0.5 shrink-0" />
                  <p className="font-serif italic text-sm text-charcoal-600">
                    For we preach not ourselves, but Christ Jesus the Lord…
                    <span className="block not-italic font-medium text-gold-600 mt-0.5">
                      — 2 Corinthians 4:5
                    </span>
                  </p>
                </div>
